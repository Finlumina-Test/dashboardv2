        ...
        {!isTakenOver ? (
          <>
            ...
            <button
              ...
              className="w-full lg:w-auto px-6 lg:px-8 py-3 lg:py-4 bg-accent hover:bg-[#ff7272] text-white rounded font-medium flex items-center justify-center gap-2 transition-all duration-200 shadow-lg hover-lift text-sm lg:text-base"
            ...
            <div className="flex items-center gap-3 w-full lg:w-auto">
              ...
              <button
                ...
                className={`flex-1 lg:flex-none p-3 lg:p-4 rounded transition-all duration-200 border ${
                  isTakenOver
                    ? isMicMuted
                      ? "bg-red-600 hover:bg-red-700 border-red-500 text-white shadow-lg shadow-red-600/30"
                      : "bg-accent hover:bg-[#ff7272] border-accent text-white shadow-lg"
                    : "bg-[#1b1c1e] hover:bg-[#2a2a2c] border-[rgba(79,79,80,0.3)] text-[#666]"
                }`}
              ...
              <button
                ...
                className="flex-1 lg:flex-none px-4 lg:px-6 py-3 lg:py-4 bg-red-600 hover:bg-red-700 text-white rounded font-medium flex items-center justify-center gap-2 transition-all duration-200 shadow-lg shadow-red-600/30 border border-red-500 text-sm lg:text-base hover-lift"
                style={{ fontFamily: 'var(--font-body)' }}
              >
          ...
          <>
            ...
            <button
              onClick={endTakeOver}
              className="w-full lg:w-auto px-6 lg:px-8 py-3 lg:py-4 bg-accent hover:bg-[#ff7272] text-white rounded font-medium flex items-center justify-center gap-2 transition-all duration-200 shadow-lg animate-pulse-soft text-sm lg:text-base hover-lift"
              style={{ fontFamily: 'var(--font-body)' }}
            >
              <PhoneOff className="w-4 h-4 lg:w-5 lg:h-5" />
              End Takeover
